      ...
      <div className={styles.bg}>
        ...
        <div className={styles.k}>
          ...
          <h2 className={styles.subTitle}>
            私たちが生み出すアイデアやサービスが、
            <br />
            デンタル分野に関わる人々にとっての新たなスタートとなる。
          </h2>
          <p className={styles.desc}>
            私たちはデンタル分野で未来を切り拓くきっかけを提供し、
            <br />
            より良い社会の実現に貢献します。
          </p>
        </div>
        ...
        <div className={styles.aboutUsItems}>
          <div className={styles.item01}>
            <Image
              src="/images/about-us-item01.png"
              width={isMobile ? 177 : 214}
              height={isMobile ? 177 : 214}
              alt="about-us01"
            ></Image>
          ...
          <div className={styles.item02}>
            <Image
              src="/images/about-us-item02.png"
              width={isMobile ? 177 : 214}
              height={isMobile ? 177 : 214}
              alt="about-us02"
            ></Image>
          ...
          <div className={styles.item03}>
            <Image
              src="/images/about-us-item03.png"
              width={isMobile ? 177 : 214}
              height={isMobile ? 177 : 214}
              alt="about-us03"
            ></Image>
