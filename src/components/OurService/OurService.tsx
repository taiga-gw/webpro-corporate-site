      ...
      <div className={styles.bg}>
        ...
        <div className={styles.ourServiceItems}>
          <div className={styles.item01}>
            <Image src="/images/our-service-item01.png" width={271} height={271} alt='about-us01'></Image>
          ...
          <div className={styles.item02}>
            <Image src="/images/our-service-item02.png" width={271} height={271} alt='about-us02'></Image>
          ...
          <div className={styles.item03}>
            <Image src="/images/our-service-item03.png" width={271} height={271} alt='about-us03'></Image>
        ...
        <div className={styles.ourServiceItems02}>
          <div className={styles.item01}>
            <Image src="/images/our-service-item04.png" width={271} height={271} alt='about-us01'></Image>
          ...
          <div className={styles.item02}>
            <Image src="/images/our-service-item05.png" width={271} height={271} alt='about-us02'></Image>
          ...
          <div className={styles.item03}>
            <Image src="/images/our-service-item06.png" width={271} height={271} alt='about-us03'></Image>
